...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  harpoon = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/ThePrimeagen/harpoon"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["melange-nvim"] = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/melange-nvim",
  ...
  undotree = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/undotree",
    url = "https://github.com/mbbill/undotree"
  },
  ["vim-be-good"] = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/vim-be-good",
    url = "https://github.com/ThePrimeagen/vim-be-good"
  },
  ["vim-closer"] = {
    loaded = true,
    path = "/Users/jesse/.local/share/nvim/site/pack/packer/start/vim-closer",
